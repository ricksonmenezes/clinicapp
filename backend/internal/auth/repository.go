...
func (r *Repository) CreateUser(ctx context.Context, email, passwordHash, role string) (*User, error) {
	...
	`, email, passwordHash, role, StatusUnverified).Scan(
...
func (r *Repository) GetUserByEmail(ctx context.Context, email string) (*User, error) {
	...
	`, email).Scan(&u.ID, &u.Email, &u.PasswordHash, &u.Role, &u.Status, &u.CreatedAt, &u.UpdatedAt)
	if err != nil {
...
func (r *Repository) GetUserByID(ctx context.Context, id string) (*User, error) {
	...
	`, id).Scan(&u.ID, &u.Email, &u.PasswordHash, &u.Role, &u.Status, &u.CreatedAt, &u.UpdatedAt)
	if err != nil {
		if errors.Is(err, pgx.ErrNoRows) {
			return nil, ErrUserNotFound
		}
